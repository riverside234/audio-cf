...
with the same label/source and at least `generation.similarity_threshold` text
similarity are collapsed to one; supported/contradicted contrast pairs remain.
