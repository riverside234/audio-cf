...
- CONTRADICTED: change one or more related caption-established propositions into clearly incompatible alternatives about the same event.
- Contrasts may change any explicitly captioned fact, including relative or subjective attributes.
- Relative contrasts such as loud versus quiet or gentle versus aggressive are valid when the caption explicitly states the grounded attribute and ordinary meanings conflict; never infer attributes from omission or general knowledge.
...
- If no explicit, clearly incompatible modification is available, select another caption fact instead of inventing one.
