...
- Before returning CONTRADICTED, compare the literal claim_text with the evidence: the conflicting alternative must appear in claim_text, which must not merely restate the caption. contradiction_basis may describe only conflicts present in claim_text; do not include planning or self-correction.
