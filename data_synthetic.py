...
def build_stats(
    ...
    return {
        ...
        "prompt_version": get_nested(
            ...
            "claim_agent_v6+qa_agent_v5+verifier_agent_v6",
        ),
...
def resolve_prompt_paths(vllm_config: Mapping[str, Any]) -> Dict[str, Path]:
    ...
    return {
        "claim_agent": resolve_path(
            prompts.get("claim_agent", "prompts/synthetic/claim_agent_v6.md"),
            Path.cwd(),
        ),
        ...
        "verifier_agent": resolve_path(
            prompts.get("verifier_agent", "prompts/synthetic/verifier_agent_v6.md"),
            Path.cwd(),
        ),
    }
